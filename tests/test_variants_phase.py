...
GCC = Toolchain(name="gcc", cc="gcc", cxx="g++", version=(15, 0), source="path")
CLANG = Toolchain(name="clang", cc="clang", cxx="clang++", version=(21, 0), source="path")
...
def test_a_toolchain_without_a_cxx_compiler_contributes_no_variant():
    assert enumerate_variants([Toolchain(name="gcc", cc="gcc", cxx=None, version=(15, 0), source="path")]) == []
