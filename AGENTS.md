...
|---|---|---|---|
| scheduling | [1](docs/phases/1-inter-kernel.md), [2](docs/phases/2-scope-def.md), [2.5](docs/phases/2.5-offload.md) | structure tree, kernel bodies, work/depth, OI | fusion/fission moves, scope unit, kernel-to-device schedule |
| kernel | [3](docs/phases/3-kernel-opt.md) | one kernel as NumPy, C++ or Fortran, its boundary | a source file or `lib<kernel>.a` with the given C entry |
